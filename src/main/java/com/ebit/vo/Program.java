...
import com.ebit.vo.event.Event;
import com.ebit.vo.event.OrderEvent;
import com.ebit.vo.rule.Condition;
import com.ebit.vo.rule.Rule;
...
public final class Program {
    ...
    static private AlertDecision evaluate(String drl, Event event) throws Exception {
        ...
        kieFileSystem.write("rule.drl", drl);
